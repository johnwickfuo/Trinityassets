...
s1.async=true;
s1.src='https://embed.tawk.to/6a691b20323fc91d4ca4c08a/1jul93up7';
s1.charset='UTF-8';
            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="{{ route('user.nfts.collection') }}"
                       class="flex items-center px-3 py-2 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 {{ request()->routeIs('user.nfts.collection') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-medium' : '' }}">
                ...
                <li>
                    <a href="{{ route('user.nfts.swap') }}"
                       class="flex items-center px-3 py-2 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 {{ request()->routeIs('user.nfts.swap') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-medium' : '' }}">
