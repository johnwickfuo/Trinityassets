...
} elseif ($_instance->childHasBeenRendered('OoA8vHn')) {
    $componentId = $_instance->getRenderedChildComponentId('OoA8vHn');
    $componentTag = $_instance->getRenderedChildComponentTagName('OoA8vHn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OoA8vHn');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('OoA8vHn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/admin/web/assetshub.live/public_html/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>